namespace WpfMinesweeper.Controls
{
    ...
    public class NumberBox : FrameworkElement
    {
        ...
        {
            int digits = (int) this.GetValue(NumberBox.DigitsProperty);
            this.Width = digits*NumberBox.bitmaps[0].Width;
            this.Height = NumberBox.bitmaps[0].Height;
            this.maxNumber = (int) Math.Pow(10d,
                digits) - 1;
            this.minNumber = -1*(int) Math.Pow(10d,
                digits - 1) + 1;
        }
        ...
        public int Number
        {
            ...
            set
            {
                this.SetValue(NumberBox.NumberProperty,
                    value);
            }
        }
        ...
        public int Digits
        {
            ...
            set
            {
                this.SetValue(NumberBox.DigitsProperty,
                    value);
            }
        }
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            var numberText = number < 0 ? number.ToString("0".PadRight(digits - 1,
                '0')) : number.ToString("0".PadRight(digits,
                    '0'));
            int numIndex = 0;
            ...
            for (int i = 0; i < digits; i++)
            {
                ...
                drawingContext.DrawImage(NumberBox.bitmaps[numIndex],
